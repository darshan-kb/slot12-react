...
function SingleClaim({claimId, gameId, ticketId, betNumber, betAmount, claimAmount, redeem}){
    return <tr>
        ...
        <td style={{ color:"black", width:"120px"}}><button style={{ width:"100px", height:"25px"}} onClick={redeem}> Claim </button></td>
    </tr>
        ...
        <div style={{marginTop:"5%", marginLeft:"20%"}}>
            ...
            
            {
                claims.map((claim)=>{
                    ...
                    return <SingleClaim key={claim.claimId} claimId={claim.claimId} gameId={claim.gameId} ticketId={claim.ticketId} betNumber={claim.betNumber} betAmount={claim.betAmount} claimAmount={claim.claimAmount} redeem={()=>redeemClaim(claim.claimId)}></SingleClaim>
                })
            }
            </thead>
            </table>
